...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_s3slider_image', 'url', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Image.page_link'
        db.add_column('cmsplugin_s3slider_image', 'page_link', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['cms.Page'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.url'
        db.delete_column('cmsplugin_s3slider_image', 'url')

        # Deleting field 'Image.page_link'
        db.delete_column('cmsplugin_s3slider_image', 'page_link_id')
