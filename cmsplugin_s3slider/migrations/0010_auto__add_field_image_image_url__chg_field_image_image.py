...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('cmsplugin_s3slider_image', 'image_url',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


        # Changing field 'Image.image'
        db.alter_column('cmsplugin_s3slider_image', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Image.image_url'
        db.delete_column('cmsplugin_s3slider_image', 'image_url')


        # Changing field 'Image.image'
        db.alter_column('cmsplugin_s3slider_image', 'image', self.gf('django.db.models.fields.files.ImageField')(default='None', max_length=100))

    models = {
        'cms.cmsplugin': {
            'Meta': {'object_name': 'CMSPlugin'},
            'changed_date': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 30, 0, 0)'}),
